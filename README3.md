...
Worlwide, there are greater than 55 million living with Alzheimer's Disease, and baring medical breakthroughs this number will double every 20 years[1]. Within medical research there is a consensus that
"Accumulation of the protein beta‐amyloid outside neurons and twisted strands of the protein tau inside neurons are hallmarks. They are accompanied by the death of neurons and damage to brain tissue. Inflammation and atrophy of brain tissue are other changes[2]." There is excitement and active research of identifying signs of alzhiemer's before it is manifest, and finding ways to treat the brain's amylid plaques and tau tangles.
...
[decision_boundaries](decision_boundaries.ipynb#pairplot)
...
Logistic Regression is better than KNearest Neighbor
But its a smal dataset which may not scale.
This was a cool excercies.
